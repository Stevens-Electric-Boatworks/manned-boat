...
GPSLogger::GPSLogger(const std::shared_ptr<IDataReceiver<type>> &data, const std::shared_ptr<IDataTransmitter>& transmitter, bool replay_mode)
...
void GPSLogger::on_data(const type data) const {
