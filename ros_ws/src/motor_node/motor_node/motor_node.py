...
from boat_data_interfaces.msg import MotorData, BoatAlarm, CANMotorData, CANBusStatus, BMSMcuSummary, BMSCellVoltage, \
    BMSPackSummary, BMSSOCSummary, BMSThermistor

import os

from motor_node.old_can_program import CANInterlink
...
class MotorNode(Node):
    def __init__(self):
        ...
        self.old_can = CANInterlink(self._logger, os.path.expanduser(file_path), self.can_motor_publisher_,
